...
public class EstudianteRepository {
    ...
    public Optional<Estudiante> findById(Long id) { // Método para encontrar un estudiante por su ID
        return Optional.ofNullable(estudiantes.get(id)); // Retorna un Optional que contiene el estudiante si existe, o vacío si no
    }
    public boolean existsById(Long id) { // Método para verificar si un estudiante existe por su ID
        return estudiantes.containsKey(id); // Retorna true si el estudiante existe, false si no
    }
